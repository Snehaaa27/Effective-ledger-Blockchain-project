...
<body>
<div class="main">	
	<h1 style=color:red>Card Payment</h1>
		...
		<ul>
			<li>
				...
				<div class="nl-content">
					...
					<form action="payment3.jsp" method="post" class="creditly-card-form agileinfo_form" autocomplete="off">
						...
						<div class="creditly-wrapper wthree">
								...
								%>
									...
									<div class="w3_agileits_card_number_grids">
										...
										<div class="w3_agileits_card_number_grid_right">
											<div class="controls">
												...
												<input class="security-code form-control" ·inputmode="numeric" type="cvv" name="security-code" placeholder="&#149;&#149;&#149;" required="">
											</div>
										</div>
										<div class="clear"> </div>
									</div>
									<div class="controls">
										...
										<input class="billing-address-name form-control" type="text" name="amt" placeholder="Enter your Amount" required="">
									</div>
								</div>
...
<!-- //js -->
<!-- credit-card -->
	<script type="text/javascript" src="js1/creditly.js"></script>
