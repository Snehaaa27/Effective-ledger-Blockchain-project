...
<body>
	...
	%>
			<h2 class="tittle-one wow fadeInDown">RECORD OF : <%=request.getParameter("uid") %></h2>
			<form action="Validatekey1" method="post">
			Enter Your Private to View Data : <input type="text" name="pkey" required><input type="submit" value="SUBMIT">
			</form>
