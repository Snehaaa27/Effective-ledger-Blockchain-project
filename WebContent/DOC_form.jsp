			...
			<div style="height: auto;">	<div class="w3-container">
					<table class="w3-table w3-card-4 w3-hoverable w3-bordered w3-striped">
						...
						<%
							...
							Statement st = null;
							try {
								/*  WHERE userid IN ( SELECT pid FROM 4_patreq	) */
						...
						<tr>
							...
							<td>
								<a href="DOC_AddReport.jsp?pid=<%=rs.getString(1)%>&pname=<%=rs.getString(2)%>">ADD </a>/
								<a href="DOC_UsersData.jsp?uid=<%=rs.getString(1)%>"> VIEW</a>
							</td>
							<td><a href="DOC_Delete.jsp?pid=<%=rs.getString(1)%>&pname=<%=rs.getString(2)%>">DELETE</a></td>
							<td></td>
						</tr>
						<%
						k++;
