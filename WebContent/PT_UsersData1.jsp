...
<body>
	...
	<center>
			<h2 class="tittle-one wow fadeInDown">BLOCKCHAIN RECORD OF : <%=(String)session.getAttribute("uid") %></h2>
			<div style="height:400px;overflow:auto;"> 	<div class="w3-container">
					<table class="w3-table w3-card-4 w3-hoverable w3-bordered w3-striped">
						...
						<tr>
							...
							<td><textarea rows=5 cols=30 readonly><%=AES.decrypt(rs.getString(5), "54gyYvvzuhfdtwq$edswt09")%></textarea></td>
