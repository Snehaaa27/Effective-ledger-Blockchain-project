...
<body>
	...
	<center>
			<h2 class="tittle-one wow fadeInDown">Verify Identity</h2>
			<div style="height: auto;">	<div class="w3-container">
			<form action="Validatekey1" method="post" autocomplete="off">
					<table class="w3-table w3-card-4 w3-hoverable w3-bordered w3-striped">
						<tr> 
							<th class="w3-grey">Patient ID</th><td><input type="text" name="pid" readonly value="<%=request.getParameter("pid")%>"></td>
						</tr>
						<tr> 
							<th class="w3-grey">Enter Authentication Key (Private Key)</th><td><input type="text" name="pkey"></td>
						</tr>
						<tr> 
							<th class="w3-grey"></th><td><input type="submit" value="SUBMIT"></td>
						</tr>
					</table>
			</form>
				</div>
