...
<body>
	...
	<center>
			<h2 class="tittle-one wow fadeInDown">ADD DOCTOR DETAILS</h2>
			<div style="height: auto;">	<div class="w3-container">
			<form action="DocRegister" method="post" autocomplete="off">
					<table class="w3-table w3-card-4 w3-hoverable w3-bordered w3-striped">
						<tr class="w3-grey"> 
							<th>Doctor Name</th><td><input name="dname" type="text"></td>
						...
						<tr>
							<th>Phone</th><td><input type="text" name="ph"></td>
							<th>Address</th><td><input type="text" name="ad"></td>
						</tr>
						<tr>
							<th>UserName</th><td><input type="text" name="demail"></td>
							<th>Password</th><td><input type="password" name="dpass"></td>
						</tr>
						<tr>
							<th></th><td><input type="hidden" name="role" value="DOCTOR"></td>
							<th></th><td><input type="submit" value="ADD DOCTOR"></td>
						</tr>
					</table>
					</form>
				</div>
