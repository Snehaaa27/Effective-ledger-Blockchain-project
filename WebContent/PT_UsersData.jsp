...
<body>
	...
	<button class="button1" name="button" value="OK" type="button"
		onclick="location.href ='HOME_Pat.jsp';">
		<span>Back</span>
	</button>
	<center>
			<h2 class="tittle-one wow fadeInDown">RECORD OF : <%=(String)session.getAttribute("uid") %></h2>
			<form action="Validatekey2" method="post" autocomplete="off">
			Enter Key to View Data : <input type="text" name="pkey" required><input type="submit" value="SUBMIT">
			</form>
			<div style="height:400px;overflow:auto;"> 	<div class="w3-container">
					<table class="w3-table w3-card-4 w3-hoverable w3-bordered w3-striped">
						...
						<%
							...
							Statement st = null;
							try {
								String qry = "SELECT * FROM 5_blockchain WHERE uid='"+(String)session.getAttribute("uid")+"'";
