...
%>
	...
	<div class="register-form-w3layouts">
		<!-- Form starts here -->
		<form action="PT_Reg_DB.jsp" method="post" autocomplete="off">
			...
			<div class="main-flex-w3ls-sectns">
				...
				<div class="field-agileinfo-spc form-w3-agile-text2">
					<input type="text" name="wei" placeholder="Weight (Kg)" required="">
				</div>
			</div>
			<div class="main-flex-w3ls-sectns">
				<div class="field-agileinfo-spc form-w3-agile-text1">
			...
			<div class="main-flex-w3ls-sectns">
			 ...
			 --><div class="radio-section">
				...
				<ul class="radio-buttons-w3-agileits">
					<li>
						<input type="radio" id="a-option" name="selector1" value="Yes">
						<label for="a-option">Yes</label>
						<div class="check"></div>
					</li>
					<li>
						<input type="radio" id="b-option" name="selector1" value="No">
